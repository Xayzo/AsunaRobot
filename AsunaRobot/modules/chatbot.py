...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            ...
            return
        await lel.edit(
            f"Dion AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            ...
            return
        await lel.edit(
            f"Dion AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
...
__help__ = """
<b> AI Chatbot </b>
Dion AI 3.0 IS THE ONLY AI SYSTEM WHICH CAN DETECT & REPLY UPTO 200 LANGUAGES
